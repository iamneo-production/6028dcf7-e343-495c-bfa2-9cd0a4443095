...
public class PasswordResetEventListener implements ApplicationListener<PasswordResetEvent>{
	...
	private void sendPasswordResetLink(PasswordResetEvent event) 
			throws Exception {
				...
				String subject = "Reset password link for Birthday EMS";
				...
				String verifyURL = event.getAppURL()+"/user/reset-password?token="+token;
